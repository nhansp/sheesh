...
<xsl:transform version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
	...
	<link rel="stylesheet" href="sheesh.css" type="text/css" />
	...
	<div id="title">
	  ...
	  <div id="contents">
	    <ul>
	      ...
	      <li><a href="https://github.com/sheesh-me/sheesh">Source</a></li>
	  ...
	  <div class="section" id="support">
	    ...
	    href="mailto:sheesh_me@googlegroups.com">the
	    mailing-list</a> or to <a
	    href="https://groups.google.com/forum/?fromgroups#!forum/sheesh_me">the
	    forum</a>, or chat with us on <a href="https://gitter.im/sheesh-me/devs">Gitter</a>;
            but please be sure that your answer isn't in the
            <a href="https://raw.githubusercontent.com/sheesh-me/sheesh/master/doc/sheesh/manual.rst">user
	    manual</a> first.
	    </p>
	  </div>
