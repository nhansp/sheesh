...
/* build by swig */
extern void init_sheesh(void);
extern void PyInit__sheesh(void);

/* create python files */
extern unsigned char _binary_python_extension_py_start;
extern unsigned char _binary_python_extension_py_end;
extern unsigned char _binary_sheesh_py_start;
extern unsigned char _binary_sheesh_py_end;
...
static int create_sheesh(const char *tmp_dir)
{
	return create_python_file(tmp_dir, "sheesh.py",
								&_binary_sheesh_py_start,
								&_binary_sheesh_py_end);
}
