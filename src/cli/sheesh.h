...
static Cli sheesh_cli = {
	.version  = VERSION,
	.name     = "sheesh",
	.subtitle = "chroot, mount --bind, and binfmt_misc without privilege/setup",
	.synopsis = "sheesh [option] ... [command]",
	.colophon = "Visit https://sheesh-me.github.io for help, bug reports, suggestions, patches, ...\n\
...
\taround, sheesh waits until all processes possibly terminate. This option forces\n\
...
\tbeing used twice.",
	...
	{ .class = "Extension options",
	  ...
	  .detail = "\tThis extension causes sheesh to create a symlink when a hardlink\n\
